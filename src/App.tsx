                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                      {m.ad_thumbnail_url ? (
                                        <img 
                                          ...
                                          alt="Ad" 
                                          style={{ width: '108px', height: '192px', borderRadius: '4px', objectFit: 'cover', border: '1px solid var(--border-color)' }} 
                                        />
                                      ) : (
                                        <div style={{ width: '108px', height: '192px', borderRadius: '4px', backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid var(--border-color)' }} />
                                      )}
                                      {m.ad_preview_url && (
                                        <a 
